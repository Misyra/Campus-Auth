...
from app.services.login_handler import (
...
class TestExecuteBrowserTask:
    ...
    async def test_existing_browser_closed_first(self):
        ...
        with patch(
            "app.services.login_handler.BrowserContextManager", return_value=mock_browser_mgr
        ), patch(
...
class TestExecuteScriptTask:
    ...
    async def test_script_execution_failure(self):
        ...
        with patch(
            ...
            "app.services.login_handler.asyncio.get_running_loop"
        ) as mock_get_loop:
    ...
    async def test_script_success_network_ok(self):
        ...
        with patch(
            ...
            "app.services.login_handler.asyncio.to_thread", new_callable=AsyncMock
