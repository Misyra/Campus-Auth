...
def delete_scheduled_task(task_id: str, request: Request) -> ActionResponse:
    ...
    api_logger.info("Delete scheduled task %s -> success=%s, message=%s", task_id, ok, message)
    return ActionResponse(success=ok, message=message)
...
async def run_scheduled_task(task_id: str, request: Request) -> ActionResponse:
    ...
    api_logger.info("Run scheduled task %s -> success=%s, message=%s", task_id, success, message)
